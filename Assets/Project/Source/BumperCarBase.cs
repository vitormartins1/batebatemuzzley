...
//			steerside = STEERSIDE.DIREITA;
	...
	void SetInvisible()
	{
		borrachao.GetComponent<Renderer>().material = translucido;
		carenagem.GetComponent<Renderer>().material = translucido;
		volante.GetComponent<Renderer>().material = translucido;
	}
	
	void SetVisible()
	{
		borrachao.GetComponent<Renderer>().material = borrachaMat;
		carenagem.GetComponent<Renderer>().material = carenagemMat;
		volante.GetComponent<Renderer>().material = volanteMat;
	}
